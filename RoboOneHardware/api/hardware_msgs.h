...
HARDWARE_MSG_DEF (HARDWARE_DISABLE_ALL_RELAYS, HardwareDisableAllRelays, hardwareDisableAllRelays, HARDWARE_EMPTY, HARDWARE_EMPTY)
HARDWARE_MSG_DEF (HARDWARE_ENABLE_ALL_RELAYS, HardwareEnableAllRelays, hardwareEnableAllRelays, HARDWARE_EMPTY, HARDWARE_EMPTY)
HARDWARE_MSG_DEF (HARDWARE_READ_RELAYS_ENABLED, HardwareReadRelaysEnabled, hardwareReadRelaysEnabled, HARDWARE_EMPTY, Bool isOn)
