...
STATE_MACHINE_MSG_DEF (STATE_MACHINE_SERVER_GET_CONTEXT, StateMachineServerGetContext, stateMachineServerGetContext, STATE_MACHINE_EMPTY, RoboOneContext roboOneContext)
