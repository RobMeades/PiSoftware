 ...
 * Definitions
 */
STATE_MACHINE_MSG_DEF (STATE_MACHINE_SERVER_NULL, StateMachineServerNull, stateMachineServerNull, STATE_MACHINE_EMPTY, STATE_MACHINE_EMPTY)
STATE_MACHINE_MSG_DEF (STATE_MACHINE_SERVER_START, StateMachineServerStart, stateMachineServerStart, STATE_MACHINE_EMPTY, Bool success)
STATE_MACHINE_MSG_DEF (STATE_MACHINE_SERVER_STOP, StateMachineServerStop, stateMachineServerStop, STATE_MACHINE_EMPTY, Bool success)
STATE_MACHINE_MSG_DEF (STATE_MACHINE_SERVER_GET_CONTEXT, StateMachineServerGetContext, stateMachineServerGetContext, STATE_MACHINE_EMPTY, RoboOneContextContainer contextContainer)
...
STATE_MACHINE_MSG_DEF (STATE_MACHINE_EVENT_TASKS_AVAILABLE, StateMachineEventTasksAvailable, stateMachineEventTasksAvailable, RoboOneTaskReq taskReq, STATE_MACHINE_EMPTY)
...
STATE_MACHINE_MSG_DEF (STATE_MACHINE_EVENT_INSUFFICIENT_CHARGE, StateMachineEventInsufficientCharge, stateMachineEventInsufficientCharge, STATE_MACHINE_EMPTY, STATE_MACHINE_EMPTY)
