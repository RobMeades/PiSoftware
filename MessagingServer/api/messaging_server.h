...
{
    SERVER_EXIT_NORMALLY = 0,
    SERVER_SUCCESS_KEEP_RUNNING = 1,
    SERVER_ERR_GENERAL_FAILURE = -1,
    SERVER_ERR_FAILED_TO_ACCEPT_CLIENT_CONNECTION = -2,
    SERVER_ERR_FAILED_TO_LISTEN_ON_SOCKET = -3,
    SERVER_ERR_FAILED_TO_BIND_SOCKET = -4,
    SERVER_ERR_FAILED_TO_CREATE_SOCKET = -5,
    SERVER_ERR_FAILED_TO_SET_SOCKET_OPTIONS = -6,
    SERVER_ERR_FAILED_TO_SEND_RESPONSE_TO_CLIENT = -7,
    SERVER_ERR_FAILED_TO_GET_MEMORY_FOR_RESPONSE = -8,
    SERVER_ERR_MESSAGE_FROM_CLIENT_INCOMPLETE_OR_TOO_LONG = -9,
    SERVER_ERR_FAILED_TO_GET_MEMORY_FOR_RECEPTION = -10,
    SERVER_ERR_MESSAGE_TOO_LARGE = -11
} ServerReturnCode;
