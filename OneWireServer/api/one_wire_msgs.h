...
MSG_DEF (READ_PIO_LOGIC_STATE_DS2408, ReadPIOLogicStateDS2408, readPIOLogicStateDS2408, ONE_WIRE_EMPTY, UInt8 data)
MSG_DEF (CHANNEL_ACCESS_READ_DS2408, ChannelAccessReadDS2408, channelAccessReadDS2408, UInt8 numBytesToRead, OneWireChannelAccessReadDS2408 channelAccessReadDS2408)
MSG_DEF (CHANNEL_ACCESS_WRITE_DS2408, ChannelAccessWriteDS2408, channelAccessWriteDS2408, UInt8 data[DS2408_MAX_BYTES_IN_CHANNEL_ACCESS], ONE_WIRE_EMPTY)
...
MSG_DEF (READ_CS_CHANNEL_SELECTION_MASK_REGISTER_DS2408, ReadCSChannelSelectionMaskRegisterDS2408, readCSChannelSelectionMaskRegisterDS2408, ONE_WIRE_EMPTY, UInt8 data)
MSG_DEF (WRITE_CS_CHANNEL_SELECTION_MASK_REGISTER_DS2408, WriteCSChannelSelectionMaskRegisterDS2408, writeCSChannelSelectionMaskRegisterDS2408, UInt8 data, ONE_WIRE_EMPTY)
MSG_DEF (READ_CS_CHANNEL_POLARITY_SELECTION_REGISTER_DS2408, ReadCSChannelPolaritySelectionRegisterDS2408, readCSChannelPolaritySelectionRegisterDS2408, ONE_WIRE_EMPTY, UInt8 data)
MSG_DEF (WRITE_CS_CHANNEL_POLARITY_SELECTION_REGISTER_DS2408, WriteCSChannelPolaritySelectionRegisterDS2408, writeCSChannelPolaritySelectionRegisterDS2408, UInt8 data, ONE_WIRE_EMPTY)
...
MSG_DEF (READ_NV_CONFIG_THRESHOLD_DS2438, ReadNVConfigThresholdDS2438, readNVConfigThresholdDS2438, ONE_WIRE_EMPTY, OneWireReadNVConfigThresholdDS2438 readNVConfigThresholdDS2438)
MSG_DEF (WRITE_NV_CONFIG_THRESHOLD_DS2438, WriteNVConfigThresholdDS2438, writeNVConfigThresholdDS2438, OneWireWriteNVConfigThresholdDS2438 writeNVConfigThresholdDS2438, ONE_WIRE_EMPTY)
MSG_DEF (READ_TIME_CAPACITY_CAL_DS2438, ReadTimeCapacityCalDS2438, readTimeCapacityCalDS2438, ONE_WIRE_EMPTY, OneWireReadTimeCapacityCalDS2438 readTimeCapacityCalDS2438)
MSG_DEF (WRITE_TIME_CAPACITY_DS2438, WriteTimeCapacityDS2438, writeTimeCapacityDS2438, OneWireWriteTimeCapacityDS2438 writeTimeCapacityDS2438, ONE_WIRE_EMPTY)
...
MSG_DEF (READ_NV_CHARGE_DISCHARGE_DS2438, ReadNVChargeDischargeDS2438, readNVChargeDischargeDS2438, ONE_WIRE_EMPTY, OneWireReadNVChargeDischargeDS2438 readNVChargeDischargeDS2438)
MSG_DEF (WRITE_NV_CHARGE_DISCHARGE_DS2438, WriteNVChargeDischargeDS2438, writeNVChargeDischargeDS2438, OneWireWriteNVChargeDischargeDS2438 writeNVChargeDischargeDS2438, ONE_WIRE_EMPTY)
MSG_DEF (READ_NV_USER_DATA_DS2438, ReadNVUserDataDS2438, readNVUserDataDS2438, UInt8 block, UInt8 mem[DS2438_NUM_BYTES_IN_PAGE])
